(function () {
    ...
    angular.module('administration')
            .constant('CONFIG', {
                ...
                'restoServerUrl': 'http://localhost/resto/2.1.x',
                /*
                 * Administration end point - accessible from :
                 *      restoServerUrl + adminstrationEndPoint
                 */
                'administrationEndpoint': '/admin',
                /*
                 * Configuration dedicated to statistics module
                 */
                'statistics': {
                    /*
                ...
                /*
                 * Configuration dedicated to authentication system
                 */
                'auth': {
                    // Set displayLocalAuth true if you want to use local authentification
